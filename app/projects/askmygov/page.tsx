    ...
    <div className="max-w-3xl mx-auto p-6 lg:pt-0 space-y-6">
      ...
      <ul className="list-disc list-inside text-gray-700">
        <div className="grid grid-cols-2 gap-4">
          {askMyGovPortfolio.techstack.main.map((tool) => (
            <li
              key={tool.name}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {askMyGovPortfolio.sections.FrontendDevelopment.items.map(
          (item, index) => (
            <div
              key={index}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {askMyGovPortfolio.sections.DevopsDevelopment.items.map(
          (item, index) => (
            <div
              key={index}
              className="flex  flex-col gap-4 bg-gray-400  rounded-lg p-4"
