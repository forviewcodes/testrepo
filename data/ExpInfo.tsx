  ...
  keyAchievementsAndContributions: [
    {
      ...
      details: [
        "Led and Contributed on developing a centralized platform, **AskGovMy**, mainly on frontend that consolidates FAQs from multiple government agencies, enhancing citizen-government communication and accessibility.",
      ],
    },
    {
