export const personalProjectsData = [
  {
    ...
    image: "/projects/personal/ExpenseTracker.png",
    gitHubUrl: "/",
    previewUrl: "/",
  },

  {
    ...
    image: "/projects/personal/NumazuDataScraper.png",
...

  {
    ...
    description: "Automating HomeLab Server infrastructure provisioning",
    image: "/projects/personal/TerraformProxmox.png",
    gitHubUrl: "/",
    previewUrl: "/",
  },
  {
    ...
    title: "Terraform : AWS",
    path: "terraformaws",
    description: "Automating AWS resource provisioning",
    image: "/projects/personal/TerraformAWS.png",
    gitHubUrl: "/",
    previewUrl: "/",
  },
];

export const collabProjectsData = [
  {
    id: 1,
    title: "MYDS",
    path: "myds",
...
export const ToolsImages = [
  ...
  //Others
  { name: "Postman", path: "/tools/others/1.png", type: "others" },
  { name: "Git", path: "/tools/others/2.png", type: "others" },
  { name: "GitHub", path: "/tools/others/3.png", type: "others" },
  { name: "Jest", path: "/tools/others/4.png", type: "others" },
